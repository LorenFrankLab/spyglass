...
**Status:** Phases 1–4 complete (preset discovery, preflight, observability, curation wrappers). Phases 5–6 remaining (test-harness fixes, canonical notebook + smoke gate).
