...
**Current UX addendum:** the UX-hardening work (a separate plan, now landed; its
planning artifacts have been removed) added a minimal first-hour single-session
path on top of the Phase 1 MVP:
...
extension growth, auto-labels, merge suggestions, and BurstPair-style plots are
