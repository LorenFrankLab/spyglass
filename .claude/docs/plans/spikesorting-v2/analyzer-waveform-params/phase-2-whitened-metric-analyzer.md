...
- [metric_curation.py:755-825](../../../../../src/spyglass/spikesorting/v2/metric_curation.py#L755-L825) — `_compute_metrics` / `_compute_merge_groups` / `ensure_extensions`; the consumers to route to the metric analyzer.
- [_metric_curation_plots.py:243-345](../../../../../src/spyglass/spikesorting/v2/_metric_curation_plots.py#L243-L345) — `peak_amplitudes_from_analyzer` (display) and `burst_pair_metrics_from_analyzer` (metric legs).
