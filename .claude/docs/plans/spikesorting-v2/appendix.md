...
- [SpikeInterface 0.104.3 — full parameter reference](#spikeinterface-01043--full-parameter-reference)
...
not docs/training. (The full source-traced parameter reference — sorters /
preprocessing / analyzer / quality metrics — is inlined below under
[full parameter reference](#spikeinterface-01043--full-parameter-reference).)
...
## SpikeInterface 0.104.3 — full parameter reference

Source-grounded reference for the SI internals the v2 phases implement against. All facts verified against SI
**0.104.3** source in the v2 env
(`/Users/edeno/miniconda3/envs/spyglass_spikesorting_v2/lib/python3.11/site-packages/spikeinterface/`)
and confirmed empirically where noted. Load this only when implementing against
SI. (Inlined here so the full source-traced tables survive the planning-doc
cleanup.)
