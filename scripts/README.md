...
This directory contains streamlined installation and validation scripts for
Spyglass.
...
`SpyglassConfig` in `settings.py`. Useful for developers to ensure installer and
