...
class SortingviewWorkspace(dj.Computed):
    ...
    def make(self, key: dict):
        ...
        h5_sorting = sv.LabboxEphysSortingExtractor.store_sorting_link_h5(sorting, str(Path(recording_path) / 'sorting.h5'))
        ...
        self.add_metrics_to_sorting(key, metrics, key['sortingview_sorting_id'])
        self.insert1(key)
    ...
    def insert_manual_curation(self, key: dict, description=''):
        ...
        sortingview_sorting_id = (SortingviewWorkspace & key).fetch1('sortingview_sorting_id')
