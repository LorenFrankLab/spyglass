...
with pynwb.NWBHDF5IO(file_in, 'r', load_namespaces=True) as io:
    ...
    for spatial_series_name in list(nwbfile.processing['behavior']['position'].spatial_series):
        spatial_series = nwbfile.processing['behavior']['position'].spatial_series.pop(spatial_series_name)
        ...
        new_spatial_series.append(pynwb.behavior.SpatialSeries(
