        ...
        Sorting.insert1(
            {
                ...
                # The display-recipe FK column (the cortex display recipe).
                # This bypassed concat insert runs with FK checks off, so the
                # row need not pre-exist, but the column is NOT NULL.
